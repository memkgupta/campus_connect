...
export const PUT = async(req:Request)=>{
    ...
    try {
       ...
       const log = await ProjectLog.findByIdAndUpdate(log_id,{description:description},{new:true});
    //    if(!log){
    ...
    //     }
        ...
        return Response.json({success:true,message:"Log deleted Successfully",log:log},{status:202});
    } catch (error) {
