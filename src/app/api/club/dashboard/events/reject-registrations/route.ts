...
export const POST = async(req:Request)=>{
    ...
    try {
        ...
        const registrations = await EventRegistration.updateMany({_id:{$in:selections}},{isAccepted:false,status:'rejected'});
        return Response.json({success:true,message:"Registrations rejected successfully"});
    } catch (error) {
