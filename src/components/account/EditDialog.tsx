...
const EditDialog = ({userDetails,setUserDetails}:{userDetails:any,setUserDetails:any}) => {
...
const [usernameMessage,setUsernameMessage] = useState('');
    ...
    const handleSubmit = async(data:Zod.infer<typeof editProfileSchema>)=>{
        ...
        const filteredInterests = userDetails.interest.filter((item:string)=>item!=value);
